...
ol.proj.get("EPSG:32651").setExtent([703136.146281, 162694.572768, 707990.122688, 165830.197468]);
var wms_layers = [];

var lyr_NDBI_0 = new ol.layer.Image({
                            opacity: 1,
                            title: "NDBI",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/NDBI_0.png",
    attributions: ' ',
...
lyr_Peta_Curah_Hujan_3.set('fieldLabels', {'OBJECTID': 'no label', 'Crh_Hjn': 'inline label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'skor_hujan': 'no label', });
lyr_Peta_Penggunaan_Lahan_4.set('fieldLabels', {'Landuse': 'inline label', 'skor_lahan': 'no label', });
lyr_Peta_Ketinggian_5.set('fieldLabels', {'gridcode': 'no label', 'ket': 'inline label', 'skor_tingg': 'no label', 'luas': 'no label', });
lyr_Peta_Kelerengan_6.set('fieldLabels', {'gridcode': 'no label', 'Klasifikas': 'inline label', 'skor_leren': 'no label', });
lyr_Peta_Jenis_Tanah_7.set('fieldLabels', {'OBJECTID': 'no label', 'LITHOLOGY': 'inline label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'skor_tanah': 'no label', });
...
lyr_Servicearealines_24.set('fieldLabels', {'Id': 'no label', 'Sarana': 'no label', 'Jangkauan': 'inline label', 'type': 'no label', 'start': 'no label', });
